...
class OCRProcess:
    ...
    def process_image(img_path, x_grid, y_grid):
        ...
        result = OCRProcess.ocr_model.ocr(img_path)
        ...
        for i, res in enumerate(result[0]):
            ...
            # If the third character is not a space, insert a space
...
# #Read image_Front
# img_front = OCRProcess.process_image('../images/p2.png', x_grid=8, y_grid=16)

# # Select the first (y_grid - 1) rows
# img_front = img_front[0:16-1]

# # Read image_behind
# img_behind = OCRProcess.process_image('../images/p2.png', x_grid=8, y_grid=16)
